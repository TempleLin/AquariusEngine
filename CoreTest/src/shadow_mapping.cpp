...
namespace shadow_mapping {
    ...
    void renderScene(const AQ_Shader& shader);
    void renderCube();
    void renderQuad();
    ...
    int main()
    {
        ...
        // -------------------------
        AQ_Shader shader("shaders/shadow_mapping.vs", "shaders/shadow_mapping.fs");
        AQ_Shader simpleDepthShader("shaders/shadow_mapping_depth.vs", "shaders/shadow_mapping_depth.fs");
        AQ_Shader debugDepthQuad("shaders/debug_quad.vs", "shaders/debug_quad_depth.fs");
